export const translations = {
  en: {
    ...
    weeklyCompletedDays: 'Days Completed This Week',
    upcoming: 'Upcoming',
    todayAbbrev: 'Now',
    reminderTime: 'When',
    anytime: 'Anytime',
    ...
    next: 'Next',
    myIcons: 'My Icons',
    searchIcons: 'Search your icons…',
    noIconsFound: 'No icons match your search.',
    nameIconTitle: 'Name This Icon',
    iconName: 'Icon Name',
    iconNamePlaceholder: 'e.g. Yoga Mat',
    saveToLibrary: 'Save to My Icons',
    useOnce: 'Just Use Once',
    iconLibrary: 'My Icon Library',
  ...
  zh: {
    ...
    myIcons: '我的图标',
    searchIcons: '搜索我的图标…',
    noIconsFound: '没有找到匹配的图标。',
    nameIconTitle: '为图标命名',
    iconName: '图标名称',
    iconNamePlaceholder: '例如：瑜伽垫',
    saveToLibrary: '保存到我的图标',
    useOnce: '仅使用一次',
    iconLibrary: '我的图标库',
